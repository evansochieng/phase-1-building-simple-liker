...
// The value of empty heart is full heart and vice versa
const likeStates = {
  [EMPTY_HEART]: FULL_HEART,
  [FULL_HEART]: EMPTY_HEART
};

// Define the color states of the like button
// empty heart becomes red if clicked clicked and vice versa
const heartColors = {
  '': 'red',
  'red': ''
};

// Add an event listener to the like buttons
// Change the  colors of the hearts 
